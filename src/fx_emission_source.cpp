...
EmissionSource::EmissionSource(FVec2 pos) : m_type(Type::point), m_pos(pos) {}
EmissionSource::EmissionSource(FRect rect)
	: m_type(Type::rect), m_pos(rect.center()), m_param(rect.size() * 0.5f) {}
EmissionSource::EmissionSource(FVec2 pos, float radius)
